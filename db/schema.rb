...
ActiveRecord::Schema.define(version: 20141223104649) do
  ...
  add_index "fee_collection_particulars_students", ["collection_id"], name: "index_fee_collection_particulars_students_on_collection_id", using: :btree
  add_index "fee_collection_particulars_students", ["fee_collection_particular_id"], name: "particular_id", using: :btree
