Rails.application.routes.draw do
  ...
  # get 'attendences/:id/display/:next', to: 'attendences#display', as: 'attendences_display'
 ...
 # get 'finance/transaction_category'
  ...
  # get 'finance/fees_collection_student', to: 'finance#fees_collection_student', as: 'finance_student'
  ...
  # get 'finance/batch_choice'student_search
